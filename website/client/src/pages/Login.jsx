                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-primary" placeholder="smith@exa.com" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-primary" placeholder="password" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
