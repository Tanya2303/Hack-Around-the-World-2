        ...
        <div>
            <div
                ...
                <div
                    ...
                    <Link to="/blog">
                        <span className="inline-flex w-auto px-3 py-2 rounded hover:bg-tertiary cursor-pointer text-white">Blog</span>
                    </Link>

                    <Link to="/translate">
                        <span className="inline-flex w-auto px-3 py-2 rounded hover:bg-tertiary cursor-pointer text-white">Translate</span>
                    </Link>
                </div>
